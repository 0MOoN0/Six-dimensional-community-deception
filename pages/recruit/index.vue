    ...
    <div class="job-position"> 
     <div class="job-type reco-job"> 
      ...
      <ul class="yui3-g job-list" style="display:block;"> 
       <li class="yui3-u-1-2 job-item" v-for="(item,index) in recommendList.rows" :key="index"> 
         <p><span class="name">
     ...
     <div class="job-type latest-job"> 
      ...
      <ul class="yui3-g job-list" style="display:block;"> 
       <li class="yui3-u-1-2 job-item" v-for="(item,index) in newList.rows" :key="index"> <p>
         <span class="name"> 
    ...
    <div class="hot-company"> 
     ...
     <div class="company"> 
      ...
      <ul class="yui3-g company" style="display:block;"> 
       <li class="yui3-u-1-3 company-item" v-for="(item,index) in hostList.rows" :key="index"> 
